  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "bg-card data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col border-none! outline-0! ring-0! gap-4 shadow-lg transition data-[state=closed]:duration-300 data-[state=open]:duration-300",
          side === "right" &&

...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded bg-card p-2 md:p-6 text-foreground border border-card-border",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "md:text-2xl text-lg pb-8 text-foreground font-semibold leading-none tracking-tight",
      className
    )}
    {...props}
  />
